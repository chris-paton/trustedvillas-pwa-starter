...
export function VillaDetails({ villaId, onNavigate }: VillaDetailsProps) {
  ...
  const [villa, setVilla] = useState<VillaDetailsData | null>(null);
  ...
  useEffect(() => {
    // Reset to loading state when villa ID or code changes
    setVilla(null);
    setIsLoading(true);
  ...
  return (
    <div className="md:mt-20 pb-20 md:pb-0">
        ...
        <div className="max-w-7xl mx-auto px-4 py-6">
          <div className="animate-pulse space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-2 md:gap-4">
              <div className="md:col-span-2 md:row-span-2 bg-gray-200 h-64 md:h-96 rounded-xl"></div>
              <div className="hidden md:block bg-gray-200 h-48 rounded-xl"></div>
              <div className="hidden md:block bg-gray-200 h-48 rounded-xl"></div>
              <div className="hidden md:block bg-gray-200 h-48 rounded-xl"></div>
              <div className="hidden md:block bg-gray-200 h-48 rounded-xl"></div>
            </div>
      ...
      {/* Actual Content - Only show when villa data is loaded */}
      {!isLoading && villa && (
        <>
          {/* Image Gallery */}
          <div className="max-w-7xl mx-auto px-4 py-6">
